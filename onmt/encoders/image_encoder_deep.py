...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        self.layer1_1 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer2 = nn.Conv2d(64, 128, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer2_1 = nn.Conv2d(128, 128, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer3 = nn.Conv2d(128, 256, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer3_1 = nn.Conv2d(256, 256, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer3_2 = nn.Conv2d(256, 256, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer5 = nn.Conv2d(256, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer5_1 = nn.Conv2d(512, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer5_2 = nn.Conv2d(512, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6 = nn.Conv2d(512, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6_1 = nn.Conv2d(512, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6_2 = nn.Conv2d(512, 512, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
    ...
    def forward(self, src, lengths=None):
        ...
        src = F.relu(self.layer1_1(src), True)
        ...
        src = F.relu(self.layer2_1(src), True)
        ...
        src = F.relu(self.layer3_1(src), True)
        src = F.relu(self.layer3_2(src), True)
        ...
        src = F.relu(self.layer5_1(src))
        src = F.relu(self.layer5_2(src))
        ...
        src = F.relu(self.layer6_1(src))
        src = F.relu(self.layer6_2(src))
