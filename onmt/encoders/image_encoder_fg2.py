...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        self.layer2 = nn.Conv2d(32, 32, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer2_2 = nn.Conv2d(32, 32, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer3 = nn.Conv2d(32, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer4 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer5 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6_2 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer7 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer8 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer9 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer9_2 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer10 = nn.Conv2d(64, 64, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
    ...
    def forward(self, src, lengths=None):
        ...
        # (batch_size, 32, imgH, imgW)
        # block 1
        src = F.relu(self.layer1(src[:, :, :, :] - 0.5), True)
        src = F.relu(self.layer2(src), True)
        src = F.relu(self.layer2_2(src), True)

        # (batch_size, 32, imgH/2, imgW/2)
        ...
        src = F.relu(self.layer6_2(src), True)

        # (batch_size, 64, imgH/2/2, imgW/2)
